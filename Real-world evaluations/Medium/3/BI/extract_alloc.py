...
app_num=20
for tt in range(1):
    alloc_file = "D:\\00Research\\00Fog\\004-Zara\\Her SLA\\TimeIntervals-medium\\3\\BI\\allocDefinitionSTA3.json"
        ...
        if (service < 80):
            ...
            if (task == 0):
                ...
                if (content_app['initialAllocation'][service]["Status"] == "Crashed"):
                    T_1[app][task][task]= T_1[app][task][task] + Tm_1[app][task][task]
            ...
            m=content_app['initialAllocation'][service]["module_name"]
            part1 = int(m.split('_')[1])
            task =( part1 - 80) % service_num_app2
            #print(content_app['initialAllocation'][service])
            #print(app2[task])
            #print(t1)
            ...
            if (task == 0):
                ...
                if (content_app['initialAllocation'][service]["Status"] == "Crashed"):
                    T_2[app][task][task]= T_2[app][task][task] + Tm_2[app][task][task]
                compl_time[app] +=  T_2[app][task][task]
                #print(task, " ",app," ",Tm_2[app][task][task]," ", Tr_2[app][task][task], " ",T_2[app][task][task])
            elif(task == 4):
