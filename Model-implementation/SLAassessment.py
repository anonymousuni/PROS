...
partition=[[1,2,3,4,11],[7,9,11],[6,8,5,10]]
SLAList=[]
SLApar=3
SP=[[10,7,5],[23,17,12],[20,18,17],[12,12,11],[25,20,20]]#SLA parameters of devices in a network partition at special time t
NP=[[13,3,5],[10,6,11],[3,2,3],[0,0,1],[5,5,0]]#SLA violation of devices in a network partition at special time t
